...
public class Program
{
     ...
     */
    private static readonly String YOUR_NAME = "YOUR_NAME";

    /* Change these constants to contain the paths out of your mazes. */
    private static readonly String PATH_OUT_OF_MAZE = "NEESESNWSWWSNESEE";
    private static readonly String PATH_OUT_OF_TWISTY_MAZE = "WSWNEEESNEWS";
